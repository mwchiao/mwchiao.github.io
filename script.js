...
function onTabClick(event, panelIndex) {
    const tab = event.target;
    if (tab.className.includes("active")) return;

    document.querySelector(".jobs-tab.active").classList.remove("active");
    tab.classList.add("active");

    // TODO: Handle behavior for showing & hiding tab content
    document.querySelector(".job-content.active").classList.remove("active");
    document.querySelector(`#panel-${panelIndex}`).classList.add("active");
}
